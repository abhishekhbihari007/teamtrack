...
A production-ready full-stack team task management application built by **Abhishekh Bihari**. Admins can create projects, assign tasks, and manage members, while team members can track their work and update task status. Features a premium, minimalist SaaS user interface with full Dark/Light mode support.
...
git clone https://github.com/abhishekhbihari007/team-task-manager.git
...
- **Bugs & feature requests** — [Open a GitHub issue](https://github.com/abhishekhbihari007/team-task-manager/issues)
- **Questions** — Use the [GitHub Discussions](https://github.com/abhishekhbihari007/team-task-manager/discussions) tab

**Maintainer:** [Abhishekh Bihari](https://github.com/abhishekhbihari007)
